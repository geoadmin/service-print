...
from print3.utils import _normalize_projection, _normalize_imageDisplay, _qrcodeurlparse, _qrcodeurlunparse, _increment_info, _zeitreihen


url_tuple = ("https://mf-chsdi3.dev.bgdi.ch/qrcodegenerator",
             "https://mf-geoadmin3.dev.bgdi.ch/",
             {'lang': 'fr',
              'layers_visibility': 'true,false,false,false',
              'bgLayer': 'voidLayer',
              'E': '2499845.99',
              'layers': 'ch.swisstopo.zeitreihen,ch.bfs.gebaeude_wohnungs_register,ch.bav.haltestellen-oev,ch.swisstopo.swisstlm3d-wanderwege',
              'zoom': '5',
              'N': '1117341.56',
              'topic': 'ech',
...
class TestServicePrintFunctional(unittest.TestCase):
    ...
    def test_zeitreihen_release(self):
        ...
        import print3
        print3.utils._get_releases_info = mock.Mock(
            return_value=timestamps_expected)
